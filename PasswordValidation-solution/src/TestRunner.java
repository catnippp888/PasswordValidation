...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("pw len >20",PasswordValidator.validate("Aa12345678901234567890")==false);
        check("pw len =20",PasswordValidator.validate("Aa123456789012345678")==true);


        // TODO: R3 - ไม่มีตัวพิมพ์ใหญ่ -> false
        check("pw no upper",PasswordValidator.validate("aaaa1234") ==false);

        // TODO: R4 - ไม่มีตัวพิมพ์เล็ก -> false
        check("pw no lower",PasswordValidator.validate("A1234567")==false);

        // TODO: R5 - ไม่มีตัวเลข -> false
        check("pw no digit",PasswordValidator.validate("Aaaaaaaa")==false);

        // TODO: R6 - มีช่องว่าง -> false
        check("pw has space",PasswordValidator.validate("A a45678")==false);

        // TODO: boundary อื่นๆ ที่คุณคิดว่าจำเป็น
        check("pw is empty",PasswordValidator.validate("")==false);
        check("pw have specialChar",PasswordValidator.validate("Aa23456_!")==true);
